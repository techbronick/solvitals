...
Generated 2026-08-15 02:06:41 UTC by SolVitals.
...
| Metric | Value |
| --- | --- |
| Non-vote TPS | 1,873.06 |
| Total TPS (incl. votes) | 3,542.88 |
| Vote share of transactions | 47.13% |
| Average slot time | 0.4093 s |
| Current slot | 439,343,969 |
| Block height | 417,395,241 |

_Non-vote TPS is the figure that reflects user activity; consensus votes are transactions on Solana and inflate the raw count._

## Epoch

Epoch **1016** — 99.99% complete (`####################`), ~0.0 hours remaining.

Slot 431,969 of 432,000. Lifetime transaction count: 538,280,968,522.
...
| Stake held by delinquents | 428,413 SOL (0.099%) |
| Total active stake | 434,241,503 SOL |
...
| --- | --- | --- | --- | --- |
| 1 | `CcaHc2L43ZWjwCHART3oZoJvHLAe9hzT2DJNUpBzoTN1` | 17,055,967 | 3.928% | 7% |
| 2 | `he1iusunGwqrNtafDtLdhsUQDFvo13z9sUa36PauBtk` | 15,972,699 | 3.678% | 0% |
| 3 | `CatzoSMUkTRidT5DwBxAC2pEtnwMBTpkCepHkFgZDiqb` | 12,477,808 | 2.873% | 5% |
| 4 | `3N7s9zXMZ4QqvHQR15t5GNHyqc89KduzMP7423eWiD5g` | 12,363,210 | 2.847% | 0% |
| 5 | `26pV97Ce83ZQ6Kz9XT4td8tdoUFPTng8Fb8gPyc53dJx` | 9,161,872 | 2.11% | 7% |
| 6 | `51JBzSTU5rAM8gLAVQKgp4WoZerQcSqWC7BitBzgUNAm` | 8,981,437 | 2.068% | 10% |
| 7 | `8GbwASqdpw4dVcwbWUxbHXMrjyQx2aKkoBR5H1GJF8iD` | 8,300,271 | 1.911% | 0% |
| 8 | `9QU2QSxhb24FUX3Tu2FpczXjpK3VYrvRudywSZaM29mF` | 7,966,398 | 1.835% | 7% |
| 9 | `CvSb7wdQAFpHuSpTYTJnX5SYH4hCfQ9VuGnqrKaKwycB` | 7,372,731 | 1.698% | 5% |
| 10 | `DumiCKHVqoCQKD8roLApzR5Fit8qGV5fVQsJV9sTZk4a` | 6,581,887 | 1.516% | 0% |

## Economics

| Metric | Value |
| --- | --- |
| SOL price | $75.39 (down 0.84%) |
| Market cap | $43.91B |
| DeFi TVL | $4.81B |
| TVL rank across chains | 3 |
| DEX volume (24h) | $1.64B (down 15.46%) |
...
| MEV tips (out-of-protocol) | $122.39K (14.71% of REV) |
| Annualised REV run-rate | $303.76M |

_REV is what the **network** captures. It is a different and much smaller figure than fees earned by applications built on Solana, which follow separately -- conflating the two overstates REV by more than 10x._

| MEV source | Tips (24h) |
| --- | --- |
| Jito MEV Tips | $99.39K |
| Harmonic | $14.84K |
| bloXroute | $8.14K |
...
Fees earned by the 288 applications built on Solana -- DEXes, launchpads, wallets and bots. Economically interesting, but not network revenue.

| Window | Application fees |
| --- | --- |
| 24 hours | $10.04M (down 1.11%) |
| 7 days | $60.67M |
| 30 days | $234.55M |
...
| Tokenized equities | $409.74M (21.93% of RWA) |
...
| Protocol | Value | 24h |
| --- | --- | --- |
| xStocks | $379.95M | -0.672% |
| Ondo Global Markets | $29.57M | -0.74% |
| Remora Markets | $217.39K | -0.013% |
...
| xStocks | $379.95M | RWA |
| OnRe | $260.64M | RWA |
| Ondo Yield Assets | $178.75M | RWA |
| Hastra | $172.37M | RWA |
| Ondo Global Markets | $29.57M | RWA |
| Theo Network thBill | $26.36M | RWA |
| Nest Credit | $22.43M | RWA |
...
| Metric | Value |
| --- | --- |
| Unique fee payers (sampled) | 1,478 |
| Blocks sampled | 3 |
| Transactions in sample | 4,576 |
| Non-vote share of sample | 55.51% |
| Signers per block | 492.7 |
...
Circulating 582,612,953 SOL of 632,134,574 total (92.17%).

## Ecosystem growth (solana.com/data)

| Metric | Value | As of | Provider |
| --- | --- | --- | --- |
| Active Addresses | 643,534 | 2026-08-13 | Dune |
| Fee Payers | 2,131,729 | 2026-08-13 | Dune |
| Transaction Count (Total) | 325,922,897 | 2026-08-13 | Dune |
| Non Vote Transaction Count (Success) | 95,149,171 | 2026-08-13 | Dune |
| Non Vote Transaction Count (Failed) | 89,587,585 | 2026-08-13 | Dune |
| DEX Volume | $1.45B | 2026-08-13 | Dune |
| DEX Traders | 574,068 | 2026-08-13 | Dune |
| Transfer Volume | $7.95B | 2026-08-13 | Dune |
| Total Stake | 434,494,967 | 2026-08-14 | Stakewiz |
| Validator Count | 686 | 2026-08-14 | Stakewiz |
| Top 3 ASN Share | 42.45 | 2026-08-14 | Stakewiz |
...
| --- | --- | --- | --- |
| Active Addresses | 2026-08-13 | 97.4% | Allium: 650,956, Artemis: 562,585, Blockworks: 346,203, Dune: 643,534, RWA: 683,410 |
| Fee Payers | 2026-08-13 | 77.8% | Allium: 2,131,768, Artemis: 3,790,711, Blockworks: 2,180,068, Dune: 2,131,729, Token Terminal: 2,135,388 |

## Announcements from key accounts

- **@solana** — fomo is for builders 👀 [(link)](https://x.com/solana/status/2088357628497785339)
- **@solana** — StonkFun has contributed over $86,000,000 of volume to RWA's on @solana over the last 10 days! Over 19,000 unique holders received a RWA for the first time via Memecoins! https://t.co/hAERjxOJWr [(link)](https://x.com/solana/status/2088313446341189900)
- **@solana** — Introducing dev tags. Teams recieve a tag, update holders, and build their community all within fomo. fomo is for builders too. https://t.co/kFVzkk03qP [(link)](https://x.com/solana/status/2088300712794980622)
- **@solana** — Everything you want to build. Everything you want to learn. Everyone you want to meet. Secure your subsidized student and dev Breakpoint tickets today and bring your big ideas to London. We'll bring everything else. https://t.co/RYv5GMLT5Y [(link)](https://x.com/solana/status/2088294977248104525)
