...
Generated 2026-08-17 21:57:37 UTC by SolVitals.
...
| Metric | Value |
| --- | --- |
| Non-vote TPS | 2,019.13 |
| Total TPS (incl. votes) | 3,689.34 |
| Vote share of transactions | 45.27% |
| Average slot time | 0.4104 s |
| Current slot | 439,931,622 |
| Block height | 417,982,027 |

_Non-vote TPS is the figure that reflects user activity; consensus votes are transactions on Solana and inflate the raw count._

## Epoch

Epoch **1018** — 36.02% complete (`#######.............`), ~31.9 hours remaining.

Slot 155,624 of 432,000. Lifetime transaction count: 539,098,976,567.
...
| MEV tips (out-of-protocol) | $123.33K (20.84% of REV) |
| Annualised REV run-rate | $216.02M |

_REV is what the **network** captures. It is a different and much smaller figure than fees earned by applications built on Solana, which follow separately -- conflating the two overstates REV by more than 10x._

| MEV source | Tips (24h) |
| --- | --- |
| Jito MEV Tips | $110.59K |
| Harmonic | $7.91K |
| bloXroute | $4.83K |
...
| Metric | Value |
| --- | --- |
| Unique fee payers (sampled) | 1,974 |
| Blocks sampled | 3 |
| Transactions in sample | 5,488 |
| Non-vote share of sample | 62.46% |
| Signers per block | 658.0 |
...
Circulating 582,895,887 SOL of 632,388,147 total (92.17%).
