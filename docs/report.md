...
Generated 2026-08-17 07:37:29 UTC by SolVitals.

## Alerts

- [WARNING] **rev_24h_usd** — rev_24h_usd is 2.5 sigma below its 288-point mean

## Network Performance

| Metric | Value |
| --- | --- |
| Non-vote TPS | 1,377.95 |
| Total TPS (incl. votes) | 3,036.58 |
| Vote share of transactions | 54.62% |
| Average slot time | 0.4132 s |
| Current slot | 439,807,533 |
| Block height | 417,858,067 |

_Non-vote TPS is the figure that reflects user activity; consensus votes are transactions on Solana and inflate the raw count._

## Epoch

Epoch **1018** — 7.3% complete (`#...................`), ~45.9 hours remaining.

Slot 31,534 of 432,000. Lifetime transaction count: 538,903,549,798.
...
| Measured slot time (`getBlockTime`) | 0.4128 s |
| Deviation from 0.4s target | 3.2% |
...
| Stake held by delinquents | 34,076 SOL (0.008%) |
...
| Metric | Value |
| --- | --- |
| SOL price | $75.82 (up 0.59%) |
| Market cap | $44.19B |
| DeFi TVL | $4.82B |
| TVL rank across chains | 3 |
| DEX volume (24h) | $1.05B (down 9.86%) |
...
| MEV tips (out-of-protocol) | $91.90K (16.4% of REV) |
| Annualised REV run-rate | $204.55M |

_REV is what the **network** captures. It is a different and much smaller figure than fees earned by applications built on Solana, which follow separately -- conflating the two overstates REV by more than 10x._

| MEV source | Tips (24h) |
| --- | --- |
| Jito MEV Tips | $79.16K |
| Harmonic | $7.91K |
| bloXroute | $4.83K |
...
Fees earned by the 289 applications built on Solana -- DEXes, launchpads, wallets and bots. Economically interesting, but not network revenue.

| Window | Application fees |
| --- | --- |
| 24 hours | $6.62M (down 18.76%) |
| 7 days | $62.67M |
| 30 days | $241.76M |
...
| Metric | Value |
| --- | --- |
| Unique fee payers (sampled) | 1,494 |
| Blocks sampled | 3 |
| Transactions in sample | 3,804 |
| Non-vote share of sample | 46.19% |
| Signers per block | 498.0 |
...
Circulating 582,899,437 SOL of 632,388,656 total (92.17%).

## Ecosystem growth (solana.com/data)

| Metric | Value | As of | Provider |
| --- | --- | --- | --- |
| Active Addresses | 445,558 | 2026-08-16 | Dune |
| Fee Payers | 1,750,913 | 2026-08-16 | Dune |
| Transaction Count (Total) | 275,708,976 | 2026-08-16 | Dune |
| Non Vote Transaction Count (Success) | 79,457,993 | 2026-08-16 | Dune |
| Non Vote Transaction Count (Failed) | 54,229,281 | 2026-08-16 | Dune |
| DEX Volume | $380.17M | 2026-08-16 | Dune |
| DEX Traders | 295,171 | 2026-08-16 | Dune |
| Transfer Volume | $4.00B | 2026-08-15 | Dune |
| Total Stake | 435,303,531 | 2026-08-17 | Stakewiz |
| Validator Count | 686 | 2026-08-17 | Stakewiz |
| Top 3 ASN Share | 42.29 | 2026-08-17 | Stakewiz |
...
| --- | --- | --- | --- |
| Active Addresses | 2026-08-16 | 27.9% | Allium: 569,753, Dune: 445,558 |

## Announcements from key accounts

- **@solana** — A quick look at where Solana stands right now 👇 • 1B+ weekly non-vote transactions • 92.5% of cumulative tokenized equities spot volume • #1 chain by DEX volume • #1 chain by app revenue Not a bad place to build. Sources: @Blockworks, @Def… [(link)](https://x.com/solana/status/2088998350351671789)
- **@solana** — Somewhere between a corner store, a silver vault, and a gacha machine, Solana had a week. Cash access hit nearly 500K retail locations, silver came onchain fully audited, and a luxury watch is waiting to be pulled. Here’s everything that s… [(link)](https://x.com/solana/status/2088992929020862907)
- **@solana** — INSIGHT: @Solana set a new record of 170M+ daily non-vote transactions, more than 10x the next closest blockchain. https://t.co/9Bmbdd11MA [(link)](https://x.com/solana/status/2088978264249577961)
