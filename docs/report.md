...
Generated 2026-08-04 21:53:01 UTC by SolVitals.
...
| Metric | Value |
| --- | --- |
| Non-vote TPS | 2,228.63 |
| Total TPS (incl. votes) | 3,845.56 |
| Vote share of transactions | 42.05% |
| Average slot time | 0.4249 s |
| Current slot | 437,254,745 |
| Block height | 415,309,427 |

_Non-vote TPS is the figure that reflects user activity; consensus votes are transactions on Solana and inflate the raw count._

## Epoch

Epoch **1012** — 16.38% complete (`###.................`), ~42.5 hours remaining.

Slot 70,746 of 432,000. Lifetime transaction count: 535,154,226,050.
...
| Stake held by delinquents | 23,320 SOL (0.005%) |
| Total active stake | 434,400,163 SOL |
...
| MEV tips (out-of-protocol) | $161.51K (20.8% of REV) |
| Annualised REV run-rate | $283.35M |

_REV is what the **network** captures. It is a different and much smaller figure than fees earned by applications built on Solana, which follow separately -- conflating the two overstates REV by more than 10x._

| MEV source | Tips (24h) |
| --- | --- |
| Jito MEV Tips | $139.31K |
| Harmonic | $14.74K |
| bloXroute | $7.45K |
...
| Non-vote share of sample | 55.31% |
...
Circulating 581,307,465 SOL of 631,630,409 total (92.03%).
