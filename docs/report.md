...
Generated 2026-08-18 03:55:04 UTC by SolVitals.
...
| Metric | Value |
| --- | --- |
| Non-vote TPS | 1,453.68 |
| Total TPS (incl. votes) | 3,105.60 |
| Vote share of transactions | 53.19% |
| Average slot time | 0.4127 s |
| Current slot | 439,983,348 |
| Block height | 418,033,735 |

_Non-vote TPS is the figure that reflects user activity; consensus votes are transactions on Solana and inflate the raw count._

## Epoch

Epoch **1018** — 48.0% complete (`##########..........`), ~25.9 hours remaining.

Slot 207,349 of 432,000. Lifetime transaction count: 539,172,533,280.
