...
Generated 2026-08-19 13:28:55 UTC by SolVitals.
...
| Metric | Value |
| --- | --- |
| Non-vote TPS | 3,130.87 |
| Total TPS (incl. votes) | 4,732.69 |
| Vote share of transactions | 33.85% |
| Average slot time | 0.4155 s |
| Current slot | 440,274,109 |
| Block height | 418,324,186 |

_Non-vote TPS is the figure that reflects user activity; consensus votes are transactions on Solana and inflate the raw count._

## Epoch

Epoch **1019** — 15.3% complete (`###.................`), ~42.4 hours remaining.

Slot 66,109 of 432,000. Lifetime transaction count: 539,609,133,426.
...
| Stake held by delinquents | 744,440 SOL (0.171%) |
...
Circulating 583,007,285 SOL of 632,514,538 total (92.17%).
