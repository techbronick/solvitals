...
Generated 2026-08-18 10:52:14 UTC by SolVitals.
...
| Metric | Value |
| --- | --- |
| Non-vote TPS | 1,164.98 |
| Total TPS (incl. votes) | 2,803.87 |
| Vote share of transactions | 58.45% |
| Average slot time | 0.4161 s |
| Current slot | 440,043,702 |
| Block height | 418,094,055 |

_Non-vote TPS is the figure that reflects user activity; consensus votes are transactions on Solana and inflate the raw count._

## Epoch

Epoch **1018** — 61.97% complete (`############........`), ~19.0 hours remaining.

Slot 267,702 of 432,000. Lifetime transaction count: 539,245,851,788.
