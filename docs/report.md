...
Generated 2026-08-08 23:16:29 UTC by SolVitals.
...
| Metric | Value |
| --- | --- |
| Non-vote TPS | 1,755.72 |
| Total TPS (incl. votes) | 3,376.81 |
| Vote share of transactions | 48.01% |
| Average slot time | 0.4231 s |
| Current slot | 438,084,560 |
| Block height | 416,138,490 |

_Non-vote TPS is the figure that reflects user activity; consensus votes are transactions on Solana and inflate the raw count._

## Epoch

Epoch **1014** — 8.46% complete (`##..................`), ~46.5 hours remaining.

Slot 36,560 of 432,000. Lifetime transaction count: 536,357,478,240.
...
| Measured slot time (`getBlockTime`) | 0.4236 s |
| Deviation from 0.4s target | 5.9% |
...
| Stake held by delinquents | 31,170 SOL (0.007%) |
...
| Metric | Value |
| --- | --- |
| Unique fee payers (sampled) | 1,736 |
| Blocks sampled | 3 |
| Transactions in sample | 5,395 |
| Non-vote share of sample | 61.43% |
| Signers per block | 578.7 |
...
Circulating 582,166,448 SOL of 631,883,554 total (92.13%).
