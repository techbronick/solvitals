...
Generated 2026-08-08 20:01:17 UTC by SolVitals.

## Alerts

- [WARNING] **price_usd** — price_usd is 2.2 sigma above its 101-point mean

## Network Performance

| Metric | Value |
| --- | --- |
| Non-vote TPS | 2,466.69 |
| Total TPS (incl. votes) | 4,085.64 |
| Vote share of transactions | 39.63% |
| Average slot time | 0.4237 s |
| Current slot | 438,056,865 |
| Block height | 416,110,821 |

_Non-vote TPS is the figure that reflects user activity; consensus votes are transactions on Solana and inflate the raw count._

## Epoch

Epoch **1014** — 2.05% complete (`....................`), ~49.9 hours remaining.

Slot 8,866 of 432,000. Lifetime transaction count: 536,312,754,085.
...
| Metric | Value |
| --- | --- |
| Unique fee payers (sampled) | 1,944 |
| Blocks sampled | 3 |
| Transactions in sample | 5,106 |
| Non-vote share of sample | 60.63% |
| Signers per block | 648.0 |
...
Circulating 582,166,838 SOL of 631,883,671 total (92.13%).
