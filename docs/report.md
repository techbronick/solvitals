...
Generated 2026-08-29 21:12:26 UTC by SolVitals.

## Alerts

- [WARNING] **price_usd** — price_usd is 2.7 sigma above its 288-point mean
...
| Metric | Value |
| --- | --- |
| Non-vote TPS | 1,737.33 |
| Total TPS (incl. votes) | 3,908.99 |
| Vote share of transactions | 55.56% |
| Average slot time | 0.3155 s |
| Current slot | 442,705,740 |
| Block height | 420,753,574 |

_Non-vote TPS is the figure that reflects user activity; consensus votes are transactions on Solana and inflate the raw count._

## Epoch

Epoch **1024** — 78.18% complete (`################....`), ~8.3 hours remaining.

Slot 337,741 of 432,000. Lifetime transaction count: 543,210,216,320.
...
| Measured slot time (`getBlockTime`) | 0.3174 s |
| Deviation from 0.4s target | -20.65% |
...
| Stake held by delinquents | 18,165 SOL (0.004%) |
...
| 10 | `DumiCKHVqoCQKD8roLApzR5Fit8qGV5fVQsJV9sTZk4a` | 6,585,996 | 1.51% | 0% |

## Economics

| Metric | Value |
| --- | --- |
| SOL price | $105.23 (up 1.44%) |
| Market cap | $61.47B |
| DeFi TVL | $5.90B |
| TVL rank across chains | 2 |
| DEX volume (24h) | $2.59B (down 29.99%) |
...
| --- | --- |
| **REV (total)** | **$1.16M** |
| Network fees | $946.01K |
| MEV tips (out-of-protocol) | $217.33K (18.68% of REV) |
| Annualised REV run-rate | $424.62M |

_REV is what the **network** captures. It is a different and much smaller figure than fees earned by applications built on Solana, which follow separately -- conflating the two overstates REV by more than 10x._

| MEV source | Tips (24h) |
| --- | --- |
| Jito MEV Tips | $179.46K |
| Harmonic | $23.75K |
| bloXroute | $14.12K |
...
| Metric | Value |
| --- | --- |
| Total tokenized RWA | $2.07B |
| Tokenized equities | $458.52M (22.11% of RWA) |
...
| Protocol | Value | 24h |
| --- | --- | --- |
| xStocks | $433.29M | -1.123% |
| Ondo Global Markets | $24.74M | -1.203% |
| Remora Markets | $485.32K | -0.574% |

### Largest tokenized-asset protocols

| Protocol | Value | Category |
| --- | --- | --- |
| BlackRock BUIDL | $886.54M | RWA |
| xStocks | $433.29M | RWA |
| OnRe | $284.64M | RWA |
| Ondo Yield Assets | $179.28M | RWA |
| Hastra | $157.92M | RWA |
| Theo Network thBill | $26.40M | RWA |
| Ondo Global Markets | $24.74M | RWA |
| Plume Vaults | $22.87M | RWA |
...
| Metric | Value |
| --- | --- |
| Unique fee payers (sampled) | 1,364 |
| Blocks sampled | 3 |
| Transactions in sample | 3,793 |
| Non-vote share of sample | 46.01% |
| Signers per block | 454.7 |
...
Circulating 584,161,241 SOL of 633,078,781 total (92.27%).

## Ecosystem growth (solana.com/data)

| Metric | Value | As of | Provider |
| --- | --- | --- | --- |
| Active Addresses | 665,527 | 2026-08-28 | Dune |
| Fee Payers | 2,460,105 | 2026-08-28 | Dune |
| Transaction Count (Total) | 353,836,938 | 2026-08-28 | Dune |
| Non Vote Transaction Count (Success) | 111,880,213 | 2026-08-28 | Dune |
| Non Vote Transaction Count (Failed) | 71,665,953 | 2026-08-28 | Dune |
| DEX Volume | $1.41B | 2026-08-28 | Dune |
| DEX Traders | 582,495 | 2026-08-28 | Dune |
| Transfer Volume | $16.82B | 2026-08-27 | Dune |
| Total Stake | 436,134,399 | 2026-08-28 | Solscan |
| Validator Count | 685 | 2026-08-29 | Stakewiz |
| Top 3 ASN Share | 45.68 | 2026-08-29 | Stakewiz |
...
| --- | --- | --- | --- |
| Active Addresses | 2026-08-28 | 25.9% | Allium: 837,981, Dune: 665,527, Goldsky: 830,634 |
