...
Generated 2026-08-13 09:22:57 UTC by SolVitals.
...
| Metric | Value |
| --- | --- |
| Non-vote TPS | 1,660.85 |
| Total TPS (incl. votes) | 3,294.36 |
| Vote share of transactions | 49.58% |
| Average slot time | 0.4132 s |
| Current slot | 438,991,463 |
| Block height | 417,043,199 |

_Non-vote TPS is the figure that reflects user activity; consensus votes are transactions on Solana and inflate the raw count._

## Epoch

Epoch **1016** — 18.39% complete (`####................`), ~40.7 hours remaining.

Slot 79,464 of 432,000. Lifetime transaction count: 537,735,940,024.
...
| Stake held by delinquents | 397,562 SOL (0.091%) |
| Total active stake | 434,272,354 SOL |
...
| --- | --- | --- | --- | --- |
| 1 | `CcaHc2L43ZWjwCHART3oZoJvHLAe9hzT2DJNUpBzoTN1` | 17,055,967 | 3.927% | 7% |
...
| Metric | Value |
| --- | --- |
| SOL price | $75.94 (down 0.51%) |
| Market cap | $44.25B |
| DeFi TVL | $4.84B |
| TVL rank across chains | 3 |
| DEX volume (24h) | $1.68B (up 1.97%) |
...
| MEV tips (out-of-protocol) | $162.62K (18.67% of REV) |
| Annualised REV run-rate | $317.95M |

_REV is what the **network** captures. It is a different and much smaller figure than fees earned by applications built on Solana, which follow separately -- conflating the two overstates REV by more than 10x._

| MEV source | Tips (24h) |
| --- | --- |
| Jito MEV Tips | $137.05K |
| Harmonic | $16.80K |
| bloXroute | $8.77K |
...
| Metric | Value |
| --- | --- |
| Unique fee payers (sampled) | 1,644 |
| Blocks sampled | 3 |
| Transactions in sample | 4,636 |
| Non-vote share of sample | 54.98% |
| Signers per block | 548.0 |
...
Circulating 582,614,380 SOL of 632,136,001 total (92.17%).

## Ecosystem growth (solana.com/data)

| Metric | Value | As of | Provider |
| --- | --- | --- | --- |
| Active Addresses | 523,712 | 2026-08-12 | Dune |
| Fee Payers | 2,044,044 | 2026-08-12 | Dune |
| Transaction Count (Total) | 318,558,124 | 2026-08-12 | Dune |
| Non Vote Transaction Count (Success) | 92,188,326 | 2026-08-12 | Dune |
| Non Vote Transaction Count (Failed) | 87,146,757 | 2026-08-12 | Dune |
| DEX Volume | $719.21M | 2026-08-12 | Dune |
| DEX Traders | 364,338 | 2026-08-12 | Dune |
| Transfer Volume | $13.51B | 2026-08-11 | Dune |
| Total Stake | 434,494,967 | 2026-08-13 | Stakewiz |
| Validator Count | 686 | 2026-08-13 | Stakewiz |
| Top 3 ASN Share | 41.17 | 2026-08-13 | Stakewiz |
...
| --- | --- | --- | --- |
| Active Addresses | 2026-08-12 | 25.6% | Allium: 657,971, Dune: 523,712 |

## Announcements from key accounts

- **@solana** — Agave 4.3 Alpenglow [(link)](https://x.com/solana/status/2087678539348754584)
...
- **@solana** — TCG platforms already reached a new all-time high in packs opened just two days into the new month. More than 537,000 packs have already been opened, with a large part of that activity coming from Solana projects like Collector Crypt. http… [(link)](https://x.com/solana/status/2087516977808228792)
- **@solana** — MoneyGram Ramps is now live on @Solana. Tap into MoneyGram’s on/off-ramp infrastructure to help your users cash in across 25+ countries and cash out across 170+ countries and territories. @riftapp is the first to integrate MoneyGram Ramps.… [(link)](https://x.com/solana/status/2087163451172892909)
