...
Generated 2026-09-02 01:43:16 UTC by SolVitals.

## Alerts

- [CRITICAL] **stablecoins_usd** — stablecoins_usd is 5.3 sigma below its 288-point mean

## Network Performance

| Metric | Value |
| --- | --- |
| Non-vote TPS | 2,459.89 |
| Total TPS (incl. votes) | 4,622.24 |
| Vote share of transactions | 46.78% |
| Average slot time | 0.3122 s |
| Current slot | 443,573,769 |
| Block height | 421,621,259 |

_Non-vote TPS is the figure that reflects user activity; consensus votes are transactions on Solana and inflate the raw count._

## Epoch

Epoch **1026** — 79.11% complete (`################....`), ~8.0 hours remaining.

Slot 341,771 of 432,000. Lifetime transaction count: 544,306,067,002.
...
| Metric | Value |
| --- | --- |
| SOL price | $99.18 (down 4.02%) |
| Market cap | $58.04B |
| DeFi TVL | $5.66B |
| TVL rank across chains | 2 |
| DEX volume (24h) | $2.36B (down 5.72%) |
...
| MEV tips (out-of-protocol) | $216.37K (20.56% of REV) |
| Annualised REV run-rate | $384.21M |

_REV is what the **network** captures. It is a different and much smaller figure than fees earned by applications built on Solana, which follow separately -- conflating the two overstates REV by more than 10x._

| MEV source | Tips (24h) |
| --- | --- |
| Jito MEV Tips | $190.16K |
| Harmonic | $16.69K |
| bloXroute | $9.51K |

### Application fees (distinct from REV)

Fees earned by the 307 applications built on Solana -- DEXes, launchpads, wallets and bots. Economically interesting, but not network revenue.

| Window | Application fees |
| --- | --- |
| 24 hours | $14.36M (up 6.33%) |
| 7 days | $86.96M |
| 30 days | $323.23M |
...
| Tokenized equities | $456.96M (22.06% of RWA) |
...
| Protocol | Value | 24h |
| --- | --- | --- |
| xStocks | $431.96M | -2.011% |
| Ondo Global Markets | $24.53M | -2.206% |
...
| xStocks | $431.96M | RWA |
| OnRe | $287.93M | RWA |
| Ondo Yield Assets | $179.34M | RWA |
| Hastra | $153.94M | RWA |
| Theo Network thBill | $26.41M | RWA |
| Ondo Global Markets | $24.53M | RWA |
| Plume Vaults | $22.88M | RWA |
...
| Blocks sampled | 3 |
| Transactions in sample | 3,929 |
| Non-vote share of sample | 52.33% |
...
| BisonFi | $204.83M |
| Raydium AMM | $152.16M |
| Manifest Trade | $147.23M |

## Supply

Circulating 585,206,320 SOL of 633,266,750 total (92.41%).

## Ecosystem growth (solana.com/data)

| Metric | Value | As of | Provider |
| --- | --- | --- | --- |
| Active Addresses | 619,485 | 2026-08-31 | Dune |
| Fee Payers | 2,270,776 | 2026-08-31 | Dune |
| Transaction Count (Total) | 350,957,884 | 2026-08-31 | Dune |
| Non Vote Transaction Count (Success) | 99,173,480 | 2026-08-31 | Dune |
| Non Vote Transaction Count (Failed) | 67,808,975 | 2026-08-31 | Dune |
| DEX Volume | $1.18B | 2026-08-31 | Dune |
| DEX Traders | 561,940 | 2026-08-31 | Dune |
| Transfer Volume | $8.38B | 2026-08-30 | Dune |
| Total Stake | 438,319,184 | 2026-08-31 | Solscan |
| Validator Count | 680 | 2026-09-01 | Stakewiz |
| Top 3 ASN Share | 49.70 | 2026-09-01 | Stakewiz |
...
| --- | --- | --- | --- |
| Active Addresses | 2026-08-31 | 27.8% | Allium: 791,527, Dune: 619,485, Goldsky: 781,387 |
