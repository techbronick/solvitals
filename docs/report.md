...
Generated 2026-08-19 12:39:34 UTC by SolVitals.
...
| Metric | Value |
| --- | --- |
| Non-vote TPS | 2,672.17 |
| Total TPS (incl. votes) | 4,266.19 |
| Vote share of transactions | 37.36% |
| Average slot time | 0.4267 s |
| Current slot | 440,267,006 |
| Block height | 418,317,110 |

_Non-vote TPS is the figure that reflects user activity; consensus votes are transactions on Solana and inflate the raw count._

## Epoch

Epoch **1019** — 13.66% complete (`###.................`), ~43.3 hours remaining.

Slot 59,006 of 432,000. Lifetime transaction count: 539,595,713,966.
...
| MEV tips (out-of-protocol) | $139.73K (17.71% of REV) |
| Annualised REV run-rate | $287.95M |

_REV is what the **network** captures. It is a different and much smaller figure than fees earned by applications built on Solana, which follow separately -- conflating the two overstates REV by more than 10x._

| MEV source | Tips (24h) |
| --- | --- |
| Jito MEV Tips | $119.59K |
| Harmonic | $12.81K |
| bloXroute | $7.32K |
...
| Metric | Value |
| --- | --- |
| Unique fee payers (sampled) | 1,755 |
| Blocks sampled | 3 |
| Transactions in sample | 5,509 |
| Non-vote share of sample | 63.24% |
| Signers per block | 585.0 |
...
Circulating 583,007,320 SOL of 632,514,573 total (92.17%).
