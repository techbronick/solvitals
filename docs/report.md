...
Generated 2026-08-17 19:04:45 UTC by SolVitals.
...
| Metric | Value |
| --- | --- |
| Non-vote TPS | 3,000.73 |
| Total TPS (incl. votes) | 4,628.70 |
| Vote share of transactions | 35.17% |
| Average slot time | 0.4184 s |
| Current slot | 439,906,627 |
| Block height | 417,957,080 |

_Non-vote TPS is the figure that reflects user activity; consensus votes are transactions on Solana and inflate the raw count._

## Epoch

Epoch **1018** — 30.24% complete (`######..............`), ~34.9 hours remaining.

Slot 130,627 of 432,000. Lifetime transaction count: 539,054,441,126.
...
| Blocks sampled | 3 |
| Transactions in sample | 5,062 |
| Non-vote share of sample | 59.72% |
...
Circulating 582,896,003 SOL of 632,388,262 total (92.17%).
