...
Generated 2026-08-22 10:10:54 UTC by SolVitals.

## Alerts

- [WARNING] **rwa_total_usd** — rwa_total_usd is 3.0 sigma above its 288-point mean
...
| Metric | Value |
| --- | --- |
| Non-vote TPS | 1,879.48 |
| Total TPS (incl. votes) | 3,739.22 |
| Vote share of transactions | 49.74% |
| Average slot time | 0.3654 s |
| Current slot | 440,899,420 |
| Block height | 418,948,794 |

_Non-vote TPS is the figure that reflects user activity; consensus votes are transactions on Solana and inflate the raw count._

## Epoch

Epoch **1020** — 60.05% complete (`############........`), ~17.5 hours remaining.

Slot 259,421 of 432,000. Lifetime transaction count: 540,658,887,098.
...
| Stake held by delinquents | 1,327,586 SOL (0.306%) |
| Total active stake | 432,157,748 SOL |
| Nakamoto coefficient | 18 |
| Median commission | 5% |
| Zero-commission validators | 253 |
...
| --- | --- | --- | --- | --- |
| 1 | `CcaHc2L43ZWjwCHART3oZoJvHLAe9hzT2DJNUpBzoTN1` | 17,066,372 | 3.949% | 7% |
| 2 | `he1iusunGwqrNtafDtLdhsUQDFvo13z9sUa36PauBtk` | 16,054,078 | 3.715% | 0% |
| 3 | `3N7s9zXMZ4QqvHQR15t5GNHyqc89KduzMP7423eWiD5g` | 12,175,413 | 2.817% | 0% |
| 4 | `CatzoSMUkTRidT5DwBxAC2pEtnwMBTpkCepHkFgZDiqb` | 11,782,032 | 2.726% | 5% |
| 5 | `26pV97Ce83ZQ6Kz9XT4td8tdoUFPTng8Fb8gPyc53dJx` | 9,178,661 | 2.124% | 7% |
| 6 | `51JBzSTU5rAM8gLAVQKgp4WoZerQcSqWC7BitBzgUNAm` | 8,917,577 | 2.064% | 10% |
| 7 | `8GbwASqdpw4dVcwbWUxbHXMrjyQx2aKkoBR5H1GJF8iD` | 8,402,660 | 1.944% | 0% |
| 8 | `9QU2QSxhb24FUX3Tu2FpczXjpK3VYrvRudywSZaM29mF` | 7,964,352 | 1.843% | 7% |
| 9 | `CvSb7wdQAFpHuSpTYTJnX5SYH4hCfQ9VuGnqrKaKwycB` | 7,357,821 | 1.703% | 5% |
| 10 | `DumiCKHVqoCQKD8roLApzR5Fit8qGV5fVQsJV9sTZk4a` | 6,547,243 | 1.515% | 0% |

## Economics

| Metric | Value |
| --- | --- |
| SOL price | $92.66 (up 1.54%) |
| Market cap | $54.09B |
| DeFi TVL | $5.56B |
...
| MEV tips (out-of-protocol) | $223.16K (19.89% of REV) |
| Annualised REV run-rate | $409.55M |

_REV is what the **network** captures. It is a different and much smaller figure than fees earned by applications built on Solana, which follow separately -- conflating the two overstates REV by more than 10x._

| MEV source | Tips (24h) |
| --- | --- |
| Jito MEV Tips | $194.31K |
| Harmonic | $17.68K |
| bloXroute | $11.11K |
...
Fees earned by the 297 applications built on Solana -- DEXes, launchpads, wallets and bots. Economically interesting, but not network revenue.

| Window | Application fees |
| --- | --- |
| 24 hours | $13.20M (up 19.19%) |
| 7 days | $72.37M |
| 30 days | $265.90M |
...
| Metric | Value |
| --- | --- |
| Total tokenized RWA | $1.96B |
| Tokenized equities | $452.46M (23.11% of RWA) |
...
| Protocol | Value | 24h |
| --- | --- | --- |
| xStocks | $427.35M | 3.999% |
| Ondo Global Markets | $24.63M | -0.086% |
| Remora Markets | $480.89K | 0.0% |
...
| Ondo Global Markets | $24.63M | RWA |
...
| Metric | Value |
| --- | --- |
| Unique fee payers (sampled) | 1,262 |
| Blocks sampled | 3 |
| Transactions in sample | 3,620 |
| Non-vote share of sample | 43.84% |
| Signers per block | 420.7 |
...
Circulating 583,177,111 SOL of 632,639,440 total (92.18%).

## Ecosystem growth (solana.com/data)

| Metric | Value | As of | Provider |
| --- | --- | --- | --- |
| Active Addresses | 799,345 | 2026-08-20 | Dune |
| Fee Payers | 2,833,725 | 2026-08-20 | Dune |
| Transaction Count (Total) | 342,479,464 | 2026-08-20 | Dune |
| Non Vote Transaction Count (Success) | 111,841,311 | 2026-08-20 | Dune |
| Non Vote Transaction Count (Failed) | 88,451,143 | 2026-08-20 | Dune |
| DEX Volume | $2.61B | 2026-08-20 | Dune |
| DEX Traders | 770,036 | 2026-08-20 | Dune |
| Transfer Volume | $22.38B | 2026-08-20 | Dune |
| Total Stake | 432,888,622 | 2026-08-21 | Stakewiz |
| Validator Count | 682 | 2026-08-21 | Stakewiz |
| Top 3 ASN Share | 46.09 | 2026-08-21 | Stakewiz |
...
| --- | --- | --- | --- |
| Active Addresses | 2026-08-20 | 107.7% | Allium: 806,791, Blockworks: 408,338, Dune: 799,345, RWA: 848,048 |
...
- **@solana** — $LLY on @Solana has surpassed $2.8M in total volume since listing yesterday. Healthcare onchain. 🌅 https://t.co/8APINWh2wQ [(link)](https://x.com/solana/status/2090909951883465063)
...
- **@solana** — I would like to announce that Shinhan Asset Management, with over $100B in AUM, has signed an MOU with the @SolanaFndn, @orca_so and @etherfuse. We will test the issuance and distribution of a tokenized $KRW-denominated fund on @Solana, us… [(link)](https://x.com/solana/status/2090744083174334830)
