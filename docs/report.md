...
Generated 2026-08-22 19:34:48 UTC by SolVitals.
...
| Metric | Value |
| --- | --- |
| Non-vote TPS | 2,216.57 |
| Total TPS (incl. votes) | 4,082.20 |
| Vote share of transactions | 45.70% |
| Average slot time | 0.3654 s |
| Current slot | 440,991,589 |
| Block height | 419,040,931 |

_Non-vote TPS is the figure that reflects user activity; consensus votes are transactions on Solana and inflate the raw count._

## Epoch

Epoch **1020** — 81.39% complete (`################....`), ~8.2 hours remaining.

Slot 351,590 of 432,000. Lifetime transaction count: 540,784,883,926.
...
| Metric | Value |
| --- | --- |
| Unique fee payers (sampled) | 1,613 |
| Blocks sampled | 3 |
| Transactions in sample | 4,972 |
| Non-vote share of sample | 59.13% |
| Signers per block | 537.7 |
...
Circulating 583,176,780 SOL of 632,639,109 total (92.18%).
