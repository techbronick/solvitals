...
Generated 2026-08-22 09:21:44 UTC by SolVitals.
...
| Metric | Value |
| --- | --- |
| Non-vote TPS | 1,584.67 |
| Total TPS (incl. votes) | 3,467.13 |
| Vote share of transactions | 54.29% |
| Average slot time | 0.3614 s |
| Current slot | 440,891,357 |
| Block height | 418,940,765 |

_Non-vote TPS is the figure that reflects user activity; consensus votes are transactions on Solana and inflate the raw count._

## Epoch

Epoch **1020** — 58.18% complete (`############........`), ~18.4 hours remaining.

Slot 251,359 of 432,000. Lifetime transaction count: 540,648,823,622.
...
| Metric | Value |
| --- | --- |
| Unique fee payers (sampled) | 1,366 |
| Blocks sampled | 3 |
| Transactions in sample | 4,075 |
| Non-vote share of sample | 50.55% |
| Signers per block | 455.3 |
...
Circulating 583,177,137 SOL of 632,639,466 total (92.18%).
