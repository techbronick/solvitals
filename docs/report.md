...
Generated 2026-08-16 15:20:13 UTC by SolVitals.
...
| Metric | Value |
| --- | --- |
| Non-vote TPS | 2,238.70 |
| Total TPS (incl. votes) | 3,875.77 |
| Vote share of transactions | 42.24% |
| Average slot time | 0.4172 s |
| Current slot | 439,666,222 |
| Block height | 417,716,814 |

_Non-vote TPS is the figure that reflects user activity; consensus votes are transactions on Solana and inflate the raw count._

## Epoch

Epoch **1017** — 74.59% complete (`###############.....`), ~12.7 hours remaining.

Slot 322,222 of 432,000. Lifetime transaction count: 538,702,011,472.
...
| Blocks sampled | 3 |
| Transactions in sample | 4,085 |
| Non-vote share of sample | 50.26% |
...
Circulating 582,784,459 SOL of 632,261,369 total (92.17%).
