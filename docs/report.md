...
Generated 2026-08-22 20:09:32 UTC by SolVitals.
...
| Metric | Value |
| --- | --- |
| Non-vote TPS | 2,071.69 |
| Total TPS (incl. votes) | 3,926.14 |
| Vote share of transactions | 47.23% |
| Average slot time | 0.3667 s |
| Current slot | 440,997,272 |
| Block height | 419,046,614 |

_Non-vote TPS is the figure that reflects user activity; consensus votes are transactions on Solana and inflate the raw count._

## Epoch

Epoch **1020** — 82.7% complete (`#################...`), ~7.6 hours remaining.

Slot 357,272 of 432,000. Lifetime transaction count: 540,793,270,513.
...
| Measured slot time (`getBlockTime`) | 0.3664 s |
| Deviation from 0.4s target | -8.4% |
...
| Stake held by delinquents | 1,427,827 SOL (0.329%) |
| Total active stake | 432,057,507 SOL |
...
| --- | --- | --- | --- | --- |
| 1 | `CcaHc2L43ZWjwCHART3oZoJvHLAe9hzT2DJNUpBzoTN1` | 17,066,372 | 3.95% | 7% |
| 2 | `he1iusunGwqrNtafDtLdhsUQDFvo13z9sUa36PauBtk` | 16,054,078 | 3.716% | 0% |
| 3 | `3N7s9zXMZ4QqvHQR15t5GNHyqc89KduzMP7423eWiD5g` | 12,175,413 | 2.818% | 0% |
| 4 | `CatzoSMUkTRidT5DwBxAC2pEtnwMBTpkCepHkFgZDiqb` | 11,782,032 | 2.727% | 5% |
...
| 7 | `8GbwASqdpw4dVcwbWUxbHXMrjyQx2aKkoBR5H1GJF8iD` | 8,402,660 | 1.945% | 0% |
...
| MEV tips (out-of-protocol) | $206.34K (18.67% of REV) |
| Annualised REV run-rate | $403.41M |

_REV is what the **network** captures. It is a different and much smaller figure than fees earned by applications built on Solana, which follow separately -- conflating the two overstates REV by more than 10x._

| MEV source | Tips (24h) |
| --- | --- |
| Jito MEV Tips | $177.49K |
| Harmonic | $17.68K |
| bloXroute | $11.11K |
...
Fees earned by the 299 applications built on Solana -- DEXes, launchpads, wallets and bots. Economically interesting, but not network revenue.

| Window | Application fees |
| --- | --- |
| 24 hours | $13.34M (up 20.35%) |
| 7 days | $73.11M |
| 30 days | $266.66M |
...
| Tokenized equities | $444.01M (22.78% of RWA) |
...
| Protocol | Value | 24h |
| --- | --- | --- |
| xStocks | $419.24M | -0.211% |
| Ondo Global Markets | $24.56M | -1.763% |
| Remora Markets | $214.37K | -55.423% |
...
| xStocks | $419.24M | RWA |
| OnRe | $273.35M | RWA |
| Ondo Yield Assets | $179.06M | RWA |
| Hastra | $168.70M | RWA |
| Theo Network thBill | $26.38M | RWA |
| Ondo Global Markets | $24.56M | RWA |
| Nest Credit | $22.48M | RWA |
...
| Metric | Value |
| --- | --- |
| Unique fee payers (sampled) | 1,416 |
| Blocks sampled | 3 |
| Transactions in sample | 4,045 |
| Non-vote share of sample | 49.74% |
| Signers per block | 472.0 |
...
Circulating 583,176,758 SOL of 632,639,087 total (92.18%).

## Ecosystem growth (solana.com/data)

| Metric | Value | As of | Provider |
| --- | --- | --- | --- |
| Active Addresses | 672,741 | 2026-08-21 | Dune |
| Fee Payers | 2,969,060 | 2026-08-21 | Dune |
| Transaction Count (Total) | 371,494,721 | 2026-08-21 | Dune |
| Non Vote Transaction Count (Success) | 125,200,111 | 2026-08-21 | Dune |
| Non Vote Transaction Count (Failed) | 91,972,280 | 2026-08-21 | Dune |
| DEX Volume | $1.96B | 2026-08-21 | Dune |
| DEX Traders | 532,460 | 2026-08-21 | Dune |
| Transfer Volume | $22.38B | 2026-08-20 | Dune |
| Total Stake | 433,122,079 | 2026-08-22 | Stakewiz |
| Validator Count | 681 | 2026-08-22 | Stakewiz |
| Top 3 ASN Share | 46.08 | 2026-08-22 | Stakewiz |
...
| --- | --- | --- | --- |
| Active Addresses | 2026-08-21 | 27.5% | Allium: 858,041, Dune: 672,741 |
