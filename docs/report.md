...
Generated 2026-08-08 23:50:46 UTC by SolVitals.
...
| Metric | Value |
| --- | --- |
| Non-vote TPS | 1,724.44 |
| Total TPS (incl. votes) | 3,335.46 |
| Vote share of transactions | 48.30% |
| Average slot time | 0.4237 s |
| Current slot | 438,089,439 |
| Block height | 416,143,360 |

_Non-vote TPS is the figure that reflects user activity; consensus votes are transactions on Solana and inflate the raw count._

## Epoch

Epoch **1014** — 9.59% complete (`##..................`), ~45.7 hours remaining.

Slot 41,440 of 432,000. Lifetime transaction count: 536,364,523,223.
...
| Stake held by delinquents | 306,370 SOL (0.071%) |
| Total active stake | 433,742,646 SOL |
| Nakamoto coefficient | 18 |
| Median commission | 5% |
| Zero-commission validators | 261 |
...
| --- | --- | --- | --- | --- |
| 1 | `CcaHc2L43ZWjwCHART3oZoJvHLAe9hzT2DJNUpBzoTN1` | 16,917,850 | 3.9% | 7% |
| 2 | `he1iusunGwqrNtafDtLdhsUQDFvo13z9sUa36PauBtk` | 15,982,576 | 3.685% | 0% |
| 3 | `CatzoSMUkTRidT5DwBxAC2pEtnwMBTpkCepHkFgZDiqb` | 12,486,046 | 2.879% | 5% |
| 4 | `3N7s9zXMZ4QqvHQR15t5GNHyqc89KduzMP7423eWiD5g` | 12,292,541 | 2.834% | 0% |
| 5 | `26pV97Ce83ZQ6Kz9XT4td8tdoUFPTng8Fb8gPyc53dJx` | 9,183,798 | 2.117% | 7% |
| 6 | `51JBzSTU5rAM8gLAVQKgp4WoZerQcSqWC7BitBzgUNAm` | 8,954,539 | 2.064% | 10% |
| 7 | `8GbwASqdpw4dVcwbWUxbHXMrjyQx2aKkoBR5H1GJF8iD` | 8,169,945 | 1.884% | 0% |
| 8 | `9QU2QSxhb24FUX3Tu2FpczXjpK3VYrvRudywSZaM29mF` | 7,938,401 | 1.83% | 7% |
| 9 | `CvSb7wdQAFpHuSpTYTJnX5SYH4hCfQ9VuGnqrKaKwycB` | 7,370,132 | 1.699% | 5% |
...
| Metric | Value |
| --- | --- |
| SOL price | $76.03 (up 3.19%) |
| Market cap | $44.26B |
| DeFi TVL | $4.82B |
| TVL rank across chains | 4 |
| DEX volume (24h) | $1.36B (down 1.28%) |
...
| --- | --- |
| **REV (total)** | **$681.23K** |
| Network fees | $552.24K |
| MEV tips (out-of-protocol) | $128.99K (18.94% of REV) |
| Annualised REV run-rate | $248.65M |

_REV is what the **network** captures. It is a different and much smaller figure than fees earned by applications built on Solana, which follow separately -- conflating the two overstates REV by more than 10x._

| MEV source | Tips (24h) |
| --- | --- |
| Jito MEV Tips | $110.22K |
| Harmonic | $12.97K |
| bloXroute | $5.79K |
| Pyth Express Relay | $8 |
...
| Metric | Value |
| --- | --- |
| Total tokenized RWA | $1.83B |
| Tokenized equities | $403.53M (22.03% of RWA) |
...
| Protocol | Value | 24h |
| --- | --- | --- |
| xStocks | $375.87M | 0.886% |
| Ondo Global Markets | $27.44M | 0.695% |
| Remora Markets | $216.41K | 0.009% |

### Largest tokenized-asset protocols

| Protocol | Value | Category |
| --- | --- | --- |
| BlackRock BUIDL | $712.22M | RWA |
| xStocks | $375.87M | RWA |
| OnRe | $251.72M | RWA |
| Ondo Yield Assets | $178.83M | RWA |
| Hastra | $173.48M | RWA |
| Ondo Global Markets | $27.44M | RWA |
| Theo Network thBill | $26.34M | RWA |
| Apollo Diversified Credit Securitize Fund | $24.88M | RWA |
| Nest Credit | $22.34M | RWA |
...
| Blocks sampled | 3 |
| Transactions in sample | 4,080 |
| Non-vote share of sample | 50.32% |
...
Circulating 582,166,421 SOL of 631,883,536 total (92.13%).

## Ecosystem growth (solana.com/data)

| Metric | Value | As of | Provider |
| --- | --- | --- | --- |
| Active Addresses | 480,444 | 2026-08-07 | Dune |
| Fee Payers | 2,049,648 | 2026-08-07 | Dune |
| Transaction Count (Total) | 301,223,434 | 2026-08-07 | Dune |
| Non Vote Transaction Count (Success) | 84,074,803 | 2026-08-07 | Dune |
| Non Vote Transaction Count (Failed) | 76,522,216 | 2026-08-07 | Dune |
| DEX Volume | $626.60M | 2026-08-07 | Dune |
| DEX Traders | 406,675 | 2026-08-07 | Dune |
| Transfer Volume | $12.55B | 2026-08-07 | Dune |
| Total Stake | 434,693,961 | 2026-08-08 | Stakewiz |
| Validator Count | 690 | 2026-08-08 | Stakewiz |
| Top 3 ASN Share | 43.08 | 2026-08-08 | Stakewiz |
...
| --- | --- | --- | --- |
| Active Addresses | 2026-08-07 | 97.4% | Allium: 612,600, Blockworks: 310,368, Dune: 480,444 |

## Announcements from key accounts

- **@solana** — ? [(link)](https://x.com/solana/status/2086178414319337783)
- **@solana** — Top 3 announcements from Solana Summit Nigeria 2026 🇳🇬 https://t.co/vi8p75IvxX [(link)](https://x.com/solana/status/2086138867178934570)
- **@solana** — Critters Quest mainnet is OPEN. Build. Gather. Craft. Hunt. Raid. Masters play first. Clones follow in 24h. https://t.co/53RarjLcji https://t.co/E7tVc2Qs4a [(link)](https://x.com/solana/status/2086120252300013881)
- **@solana** — https://t.co/oNE8Aba5eM [(link)](https://x.com/solana/status/2086010473602777096)
...
**Cluster versions:** mainnet `4.2.0-rc.1` · testnet `4.2.0-rc.0` · devnet `4.2.0-rc.0`
