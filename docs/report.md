...
Generated 2026-08-24 13:27:44 UTC by SolVitals.
...
| Metric | Value |
| --- | --- |
| Non-vote TPS | 2,110.10 |
| Total TPS (incl. votes) | 3,968.62 |
| Vote share of transactions | 46.83% |
| Average slot time | 0.3654 s |
| Current slot | 441,404,015 |
| Block height | 419,453,003 |

_Non-vote TPS is the figure that reflects user activity; consensus votes are transactions on Solana and inflate the raw count._

## Epoch

Epoch **1021** — 76.86% complete (`###############.....`), ~10.1 hours remaining.

Slot 332,015 of 432,000. Lifetime transaction count: 541,352,078,882.
...
| Stake held by delinquents | 2,262,212 SOL (0.522%) |
| Total active stake | 431,174,101 SOL |
...
| 5 | `26pV97Ce83ZQ6Kz9XT4td8tdoUFPTng8Fb8gPyc53dJx` | 9,165,202 | 2.126% | 7% |
| 6 | `51JBzSTU5rAM8gLAVQKgp4WoZerQcSqWC7BitBzgUNAm` | 8,876,408 | 2.059% | 10% |
...
| MEV tips (out-of-protocol) | $150.48K (17.76% of REV) |
| Annualised REV run-rate | $309.29M |

_REV is what the **network** captures. It is a different and much smaller figure than fees earned by applications built on Solana, which follow separately -- conflating the two overstates REV by more than 10x._

| MEV source | Tips (24h) |
| --- | --- |
| Jito MEV Tips | $129.28K |
| Harmonic | $13.38K |
| bloXroute | $7.82K |
...
| Metric | Value |
| --- | --- |
| Unique fee payers (sampled) | 1,474 |
| Blocks sampled | 3 |
| Transactions in sample | 4,141 |
| Non-vote share of sample | 53.59% |
| Signers per block | 491.3 |
...
Circulating 583,276,125 SOL of 632,749,235 total (92.18%).

## Ecosystem growth (solana.com/data)

| Metric | Value | As of | Provider |
| --- | --- | --- | --- |
| Active Addresses | 767,097 | 2026-08-22 | Dune |
| Fee Payers | 2,770,633 | 2026-08-22 | Dune |
| Transaction Count (Total) | 332,964,643 | 2026-08-22 | Dune |
| Non Vote Transaction Count (Success) | 105,201,952 | 2026-08-22 | Dune |
| Non Vote Transaction Count (Failed) | 67,726,647 | 2026-08-22 | Dune |
| DEX Volume | $3.45B | 2026-08-22 | Dune |
| DEX Traders | 810,881 | 2026-08-22 | Dune |
| Transfer Volume | $14.03B | 2026-08-22 | Dune |
| Total Stake | 429,045,000 | 2026-08-23 | Stakewiz |
| Validator Count | 679 | 2026-08-23 | Stakewiz |
| Top 3 ASN Share | 45.72 | 2026-08-23 | Stakewiz |
...
| --- | --- | --- | --- |
| Active Addresses | 2026-08-22 | 104.5% | Allium: 772,378, Artemis: 685,423, Blockworks: 429,514, Dune: 767,097, RWA: 878,164 |
| Fee Payers | 2026-08-22 | 77.8% | Allium: 2,770,679, Artemis: 4,925,547, Blockworks: 2,827,562, Dune: 2,770,633, Token Terminal: 2,769,795 |

## Announcements from key accounts

- **@solana** — The previous record lasted seven days. Source: @Blockworks https://t.co/dWOFdNbvD4 [(link)](https://x.com/solana/status/2091849078451884051)
- **@solana** — BREAKING: Solana processes 1.318B non-vote transactions in a single week. New ATH. https://t.co/FpRARH7pzZ [(link)](https://x.com/solana/status/2091849075457237357)
- **@solana** — Our $75 Solana Special Pack is live. 🟣🟢 Every pack features Pokémon cards matching the iconic colors of Solana. And who better to crack the very first one than @taylorfox__ from @solana? First pack. First shot. Gengar pulled. Think you can… [(link)](https://x.com/solana/status/2091789486048833813)
- **@solana** — BREAKING: @Solana continues to surpass all L1 and L2 chains in weekly DEX volume for the 17th consecutive week. https://t.co/EiYRboKjj3 [(link)](https://x.com/solana/status/2091776511095300285)
