...
Generated 2026-08-11 12:06:14 UTC by SolVitals.
...
| Metric | Value |
| --- | --- |
| Non-vote TPS | 1,718.40 |
| Total TPS (incl. votes) | 3,348.62 |
| Vote share of transactions | 48.68% |
| Average slot time | 0.4202 s |
| Current slot | 438,603,252 |
| Block height | 416,656,933 |

_Non-vote TPS is the figure that reflects user activity; consensus votes are transactions on Solana and inflate the raw count._

## Epoch

Epoch **1015** — 28.53% complete (`######..............`), ~36.0 hours remaining.

Slot 123,252 of 432,000. Lifetime transaction count: 537,127,257,699.
...
| Stake held by delinquents | 409,421 SOL (0.094%) |
| Total active stake | 434,521,599 SOL |
...
| MEV tips (out-of-protocol) | $162.91K (19.31% of REV) |
| Annualised REV run-rate | $307.86M |

_REV is what the **network** captures. It is a different and much smaller figure than fees earned by applications built on Solana, which follow separately -- conflating the two overstates REV by more than 10x._

| MEV source | Tips (24h) |
| --- | --- |
| Jito MEV Tips | $139.45K |
| Harmonic | $15.97K |
| bloXroute | $7.49K |
...
| Tokenized equities | $398.40M (21.74% of RWA) |
...
| Protocol | Value | 24h |
| --- | --- | --- |
| xStocks | $371.11M | -0.556% |
| Ondo Global Markets | $27.29M | -0.571% |
...
| Hastra | $175.33M | RWA |
| Ondo Global Markets | $27.29M | RWA |
| Theo Network thBill | $26.34M | RWA |
| Apollo Diversified Credit Securitize Fund | $24.89M | RWA |
...
| Blocks sampled | 3 |
| Transactions in sample | 4,206 |
| Non-vote share of sample | 51.31% |
...
Circulating 582,481,548 SOL of 632,009,607 total (92.16%).

## Ecosystem growth (solana.com/data)

| Metric | Value | As of | Provider |
| --- | --- | --- | --- |
| Active Addresses | 489,228 | 2026-08-10 | Dune |
...
| DEX Volume | $823.02M | 2026-08-10 | Dune |
| DEX Traders | 361,091 | 2026-08-10 | Dune |
| Transfer Volume | $6.54B | 2026-08-09 | Dune |
| Total Stake | 434,786,513 | 2026-08-11 | Stakewiz |
| Validator Count | 689 | 2026-08-11 | Stakewiz |
| Top 3 ASN Share | 46.55 | 2026-08-11 | Stakewiz |
...
| --- | --- | --- | --- |
| Active Addresses | 2026-08-10 | 28.4% | Allium: 628,173, Dune: 489,228 |
