...
Generated 2026-08-23 20:56:18 UTC by SolVitals.
...
| Metric | Value |
| --- | --- |
| Non-vote TPS | 1,881.85 |
| Total TPS (incl. votes) | 3,744.27 |
| Vote share of transactions | 49.74% |
| Average slot time | 0.3654 s |
| Current slot | 441,240,995 |
| Block height | 419,290,055 |

_Non-vote TPS is the figure that reflects user activity; consensus votes are transactions on Solana and inflate the raw count._

## Epoch

Epoch **1021** — 39.12% complete (`########............`), ~26.8 hours remaining.

Slot 168,995 of 432,000. Lifetime transaction count: 541,132,935,664.
...
Circulating 583,276,703 SOL of 632,749,813 total (92.18%).
