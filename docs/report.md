...
Generated 2026-08-18 10:15:57 UTC by SolVitals.
...
| Metric | Value |
| --- | --- |
| Non-vote TPS | 1,248.45 |
| Total TPS (incl. votes) | 2,884.73 |
| Vote share of transactions | 56.72% |
| Average slot time | 0.4172 s |
| Current slot | 440,038,468 |
| Block height | 418,088,846 |

_Non-vote TPS is the figure that reflects user activity; consensus votes are transactions on Solana and inflate the raw count._

## Epoch

Epoch **1018** — 60.76% complete (`############........`), ~19.6 hours remaining.

Slot 262,468 of 432,000. Lifetime transaction count: 539,239,658,914.
...
| Stake held by delinquents | 92,398 SOL (0.021%) |
| Total active stake | 435,584,398 SOL |
...
| MEV tips (out-of-protocol) | $144.97K (16.52% of REV) |
| Annualised REV run-rate | $320.37M |

_REV is what the **network** captures. It is a different and much smaller figure than fees earned by applications built on Solana, which follow separately -- conflating the two overstates REV by more than 10x._

| MEV source | Tips (24h) |
| --- | --- |
| Jito MEV Tips | $123.89K |
| Harmonic | $13.05K |
| bloXroute | $8.03K |
...
| Blocks sampled | 3 |
| Transactions in sample | 3,685 |
| Non-vote share of sample | 44.83% |
...
Circulating 582,895,518 SOL of 632,387,777 total (92.17%).
