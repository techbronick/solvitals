...
Generated 2026-08-14 07:04:42 UTC by SolVitals.

## Alerts

- [CRITICAL] **equities_usd** — equities_usd is 3.3 sigma above its 231-point mean
- [WARNING] **unique_signers_sampled** — unique_signers_sampled is 2.0 sigma above its 231-point mean

## Network Performance

| Metric | Value |
| --- | --- |
| Non-vote TPS | 1,465.69 |
| Total TPS (incl. votes) | 3,108.32 |
| Vote share of transactions | 52.85% |
| Average slot time | 0.4138 s |
| Current slot | 439,179,017 |
| Block height | 417,230,419 |

_Non-vote TPS is the figure that reflects user activity; consensus votes are transactions on Solana and inflate the raw count._

## Epoch

Epoch **1016** — 61.81% complete (`############........`), ~19.0 hours remaining.

Slot 267,017 of 432,000. Lifetime transaction count: 538,030,947,904.
...
| Measured slot time (`getBlockTime`) | 0.4156 s |
| Deviation from 0.4s target | 3.9% |
...
| Stake held by delinquents | 118,411 SOL (0.027%) |
| Total active stake | 434,551,505 SOL |
...
| 2 | `he1iusunGwqrNtafDtLdhsUQDFvo13z9sUa36PauBtk` | 15,972,699 | 3.676% | 0% |
...
| 7 | `8GbwASqdpw4dVcwbWUxbHXMrjyQx2aKkoBR5H1GJF8iD` | 8,300,271 | 1.91% | 0% |
...
| Metric | Value |
| --- | --- |
| SOL price | $75.45 (down 1.23%) |
| Market cap | $43.96B |
| DeFi TVL | $4.84B |
| TVL rank across chains | 3 |
| DEX volume (24h) | $1.98B (up 14.66%) |
...
| MEV tips (out-of-protocol) | $146.51K (17.11% of REV) |
| Annualised REV run-rate | $312.56M |

_REV is what the **network** captures. It is a different and much smaller figure than fees earned by applications built on Solana, which follow separately -- conflating the two overstates REV by more than 10x._

| MEV source | Tips (24h) |
| --- | --- |
| Jito MEV Tips | $123.52K |
| Harmonic | $14.84K |
| bloXroute | $8.14K |
...
Fees earned by the 287 applications built on Solana -- DEXes, launchpads, wallets and bots. Economically interesting, but not network revenue.

| Window | Application fees |
| --- | --- |
| 24 hours | $10.09M (up 4.33%) |
| 7 days | $66.39M |
| 30 days | $238.44M |
...
| Tokenized equities | $413.08M (22.09% of RWA) |
...
| Protocol | Value | 24h |
| --- | --- | --- |
| xStocks | $383.37M | 1.684% |
| Ondo Global Markets | $29.49M | 1.13% |
| Remora Markets | $217.42K | 0.008% |

### Largest tokenized-asset protocols

| Protocol | Value | Category |
| --- | --- | --- |
| BlackRock BUIDL | $740.89M | RWA |
| xStocks | $383.37M | RWA |
| OnRe | $258.72M | RWA |
| Ondo Yield Assets | $178.65M | RWA |
| Hastra | $172.97M | RWA |
| Ondo Global Markets | $29.49M | RWA |
| Theo Network thBill | $26.36M | RWA |
| Nest Credit | $22.42M | RWA |
...
| Metric | Value |
| --- | --- |
| Unique fee payers (sampled) | 1,907 |
| Blocks sampled | 3 |
| Transactions in sample | 4,002 |
| Non-vote share of sample | 49.18% |
| Signers per block | 635.7 |
...
Circulating 582,613,609 SOL of 632,135,229 total (92.17%).

## Ecosystem growth (solana.com/data)

| Metric | Value | As of | Provider |
| --- | --- | --- | --- |
| Active Addresses | 650,448 | 2026-08-12 | Dune |
...
| DEX Volume | $1.53B | 2026-08-12 | Dune |
| DEX Traders | 548,123 | 2026-08-12 | Dune |
| Transfer Volume | $10.96B | 2026-08-12 | Dune |
| Total Stake | 434,494,967 | 2026-08-13 | Stakewiz |
| Validator Count | 686 | 2026-08-13 | Stakewiz |
| Top 3 ASN Share | 43.21 | 2026-08-13 | Stakewiz |
...
| --- | --- | --- | --- |
| Active Addresses | 2026-08-12 | 91.4% | Allium: 657,971, Blockworks: 349,325, Dune: 650,448, RWA: 668,508 |

## Announcements from key accounts

- **@solana** — Full episode on @DecryptMedia: https://t.co/Ha2UVRyP9q [(link)](https://x.com/solana/status/2087955919057437042)
- **@solana** — "Solana is well-positioned as the everything chain" – @mdudas https://t.co/1kRhJyZWkZ [(link)](https://x.com/solana/status/2087955917291577831)
- **@solana** — BREAKING: $SILV from @Dominion_Market is live on Solana via @sunrise https://t.co/9hFJCB9ghA [(link)](https://x.com/solana/status/2087903379955888427)
- **@solana** — Today we sat down with @mdudas to chat about @solana and its ecosystem! 3:30 - Solana's place this cycle 7:10 - Thoughts on the latest Solana Governance vote 8:40 - Are Memecoins back? 14:40 - El Toad Pepe backstory 18:07 - How to make a m… [(link)](https://x.com/solana/status/2087575179752776015)
