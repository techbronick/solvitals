...
Generated 2026-08-15 06:37:26 UTC by SolVitals.
...
| Metric | Value |
| --- | --- |
| Non-vote TPS | 1,339.25 |
| Total TPS (incl. votes) | 2,963.91 |
| Vote share of transactions | 54.81% |
| Average slot time | 0.4178 s |
| Current slot | 439,383,027 |
| Block height | 417,433,926 |

_Non-vote TPS is the figure that reflects user activity; consensus votes are transactions on Solana and inflate the raw count._

## Epoch

Epoch **1017** — 9.03% complete (`##..................`), ~45.5 hours remaining.

Slot 39,027 of 432,000. Lifetime transaction count: 538,329,944,529.
...
| Metric | Value |
| --- | --- |
| Unique fee payers (sampled) | 1,372 |
| Blocks sampled | 3 |
| Transactions in sample | 3,704 |
| Non-vote share of sample | 44.95% |
| Signers per block | 457.3 |
...
Circulating 582,728,362 SOL of 632,262,347 total (92.17%).
