...
Generated 2026-08-26 20:18:09 UTC by SolVitals.

## Alerts

- [WARNING] **rwa_total_usd** — rwa_total_usd is 2.1 sigma above its 288-point mean
...
| Metric | Value |
| --- | --- |
| Non-vote TPS | 2,947.81 |
| Total TPS (incl. votes) | 4,782.11 |
| Vote share of transactions | 38.36% |
| Average slot time | 0.3645 s |
| Current slot | 441,943,846 |
| Block height | 419,992,238 |

_Non-vote TPS is the figure that reflects user activity; consensus votes are transactions on Solana and inflate the raw count._

## Epoch

Epoch **1023** — 1.82% complete (`....................`), ~43.3 hours remaining.

Slot 7,848 of 432,000. Lifetime transaction count: 542,146,755,011.
...
| Stake held by delinquents | 1,166,428 SOL (0.267%) |
| Total active stake | 435,718,409 SOL |
...
| --- | --- | --- | --- | --- |
| 1 | `CcaHc2L43ZWjwCHART3oZoJvHLAe9hzT2DJNUpBzoTN1` | 17,062,869 | 3.916% | 7% |
| 2 | `he1iusunGwqrNtafDtLdhsUQDFvo13z9sUa36PauBtk` | 16,029,433 | 3.679% | 0% |
| 3 | `3N7s9zXMZ4QqvHQR15t5GNHyqc89KduzMP7423eWiD5g` | 12,314,379 | 2.826% | 0% |
| 4 | `CatzoSMUkTRidT5DwBxAC2pEtnwMBTpkCepHkFgZDiqb` | 11,751,683 | 2.697% | 5% |
| 5 | `26pV97Ce83ZQ6Kz9XT4td8tdoUFPTng8Fb8gPyc53dJx` | 9,216,852 | 2.115% | 7% |
| 6 | `8GbwASqdpw4dVcwbWUxbHXMrjyQx2aKkoBR5H1GJF8iD` | 9,051,084 | 2.077% | 0% |
| 7 | `51JBzSTU5rAM8gLAVQKgp4WoZerQcSqWC7BitBzgUNAm` | 8,904,595 | 2.044% | 10% |
| 8 | `9QU2QSxhb24FUX3Tu2FpczXjpK3VYrvRudywSZaM29mF` | 7,849,682 | 1.802% | 7% |
| 9 | `CvSb7wdQAFpHuSpTYTJnX5SYH4hCfQ9VuGnqrKaKwycB` | 7,301,740 | 1.676% | 5% |
| 10 | `DumiCKHVqoCQKD8roLApzR5Fit8qGV5fVQsJV9sTZk4a` | 6,578,261 | 1.51% | 0% |

## Economics

| Metric | Value |
| --- | --- |
| SOL price | $96.83 (down 1.03%) |
| Market cap | $56.55B |
| DeFi TVL | $5.57B |
...
| MEV tips (out-of-protocol) | $257.29K (22.44% of REV) |
| Annualised REV run-rate | $418.45M |

_REV is what the **network** captures. It is a different and much smaller figure than fees earned by applications built on Solana, which follow separately -- conflating the two overstates REV by more than 10x._

| MEV source | Tips (24h) |
| --- | --- |
| Jito MEV Tips | $221.95K |
| Harmonic | $23.56K |
| bloXroute | $11.77K |
| Pyth Express Relay | $10 |
...
| Metric | Value |
| --- | --- |
| Total tokenized RWA | $2.05B |
| Tokenized equities | $449.84M (21.93% of RWA) |
...
| Protocol | Value | 24h |
| --- | --- | --- |
| xStocks | $424.93M | -1.245% |
| Ondo Global Markets | $24.70M | -3.423% |
| Remora Markets | $217.69K | 0.489% |

### Largest tokenized-asset protocols

| Protocol | Value | Category |
| --- | --- | --- |
| BlackRock BUIDL | $876.47M | RWA |
| xStocks | $424.93M | RWA |
| OnRe | $277.79M | RWA |
| Ondo Yield Assets | $179.26M | RWA |
| Hastra | $160.00M | RWA |
| Theo Network thBill | $26.39M | RWA |
| Ondo Global Markets | $24.70M | RWA |
...
| Metric | Value |
| --- | --- |
| Unique fee payers (sampled) | 2,045 |
| Blocks sampled | 3 |
| Transactions in sample | 5,345 |
| Non-vote share of sample | 61.83% |
| Signers per block | 681.7 |
...
Circulating 584,063,733 SOL of 632,970,166 total (92.27%).

## Ecosystem growth (solana.com/data)

| Metric | Value | As of | Provider |
| --- | --- | --- | --- |
| Active Addresses | 638,200 | 2026-08-25 | Dune |
| Fee Payers | 2,717,400 | 2026-08-25 | Dune |
| Transaction Count (Total) | 347,142,616 | 2026-08-25 | Dune |
| Non Vote Transaction Count (Success) | 111,459,322 | 2026-08-25 | Dune |
| Non Vote Transaction Count (Failed) | 74,757,575 | 2026-08-25 | Dune |
| DEX Volume | $1.66B | 2026-08-25 | Dune |
| DEX Traders | 548,299 | 2026-08-25 | Dune |
| Transfer Volume | $20.18B | 2026-08-24 | Dune |
| Total Stake | 434,998,389 | 2026-08-26 | Stakewiz |
| Validator Count | 685 | 2026-08-26 | Stakewiz |
| Top 3 ASN Share | 46.33 | 2026-08-26 | Stakewiz |
...
| --- | --- | --- | --- |
| Active Addresses | 2026-08-25 | 24.5% | Allium: 794,650, Dune: 638,200 |

## Announcements from key accounts

- **@solana** — Demos, talks, and special appearances 👀 Watch Solana Summit Serbia @SuperteamBLKN from home https://t.co/slQS2s3suq [(link)](https://x.com/solana/status/2092533152275202224)
- **@solana** — gm https://t.co/KAkHSAPmRo [(link)](https://x.com/solana/status/2092529144378917213)
- **@solana** — Janamat has now crossed 10,000 users🇳🇵 We're building Nepal's governance infrastructure on @Solana. If you're a Nepali, your voice deserves to be heard. Still day 1. https://t.co/OPvF6BG9fh [(link)](https://x.com/solana/status/2092525575999303959)
- **@solana** — Memecoins paired with anything. Memes have traditionally been paired with $SOL, meaning you would trade coins directly against Solana. Now, there’s a new way to launch & trade anything. You can launch coins paired with a broad list of cust… [(link)](https://x.com/solana/status/2092432236389806146)
...
**Cluster versions:** mainnet `4.2.0` · testnet `4.2.0` · devnet `4.2.1`
