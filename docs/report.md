...
Generated 2026-08-07 08:47:22 UTC by SolVitals.

## Alerts

- [WARNING] **rev_24h_usd** — rev_24h_usd is 2.5 sigma below its 37-point mean

## Network Performance

| Metric | Value |
| --- | --- |
| Non-vote TPS | 1,514.21 |
| Total TPS (incl. votes) | 3,153.86 |
| Vote share of transactions | 51.99% |
| Average slot time | 0.4161 s |
| Current slot | 437,756,670 |
| Block height | 415,810,799 |

_Non-vote TPS is the figure that reflects user activity; consensus votes are transactions on Solana and inflate the raw count._

## Epoch

Epoch **1013** — 32.56% complete (`#######.............`), ~33.9 hours remaining.

Slot 140,670 of 432,000. Lifetime transaction count: 535,867,908,493.
...
| Stake held by delinquents | 125,136 SOL (0.029%) |
| Total active stake | 434,714,752 SOL |
...
| --- | --- | --- | --- | --- |
| 1 | `CcaHc2L43ZWjwCHART3oZoJvHLAe9hzT2DJNUpBzoTN1` | 16,882,234 | 3.884% | 7% |
...
| MEV tips (out-of-protocol) | $124.69K (19.46% of REV) |
| Annualised REV run-rate | $233.90M |

_REV is what the **network** captures. It is a different and much smaller figure than fees earned by applications built on Solana, which follow separately -- conflating the two overstates REV by more than 10x._

| MEV source | Tips (24h) |
| --- | --- |
| Jito MEV Tips | $106.43K |
| Harmonic | $11.85K |
| bloXroute | $6.41K |
...
| Metric | Value |
| --- | --- |
| Total tokenized RWA | $1.81B |
| Tokenized equities | $392.95M (21.76% of RWA) |
...
| Protocol | Value | 24h |
| --- | --- | --- |
| xStocks | $365.97M | 0.019% |
| Ondo Global Markets | $26.97M | 0.452% |

### Largest tokenized-asset protocols

| Protocol | Value | Category |
| --- | --- | --- |
| BlackRock BUIDL | $697.09M | RWA |
| xStocks | $365.97M | RWA |
| OnRe | $251.56M | RWA |
| Ondo Yield Assets | $178.95M | RWA |
| Hastra | $173.74M | RWA |
| Ondo Global Markets | $26.97M | RWA |
...
| Blocks sampled | 3 |
| Transactions in sample | 3,600 |
| Non-vote share of sample | 43.53% |
...
Circulating 582,052,060 SOL of 631,756,680 total (92.13%).

## Ecosystem growth (solana.com/data)

| Metric | Value | As of | Provider |
| --- | --- | --- | --- |
| Active Addresses | 597,414 | 2026-08-05 | Dune |
...
| DEX Volume | $1.34B | 2026-08-05 | Dune |
| DEX Traders | 555,269 | 2026-08-05 | Dune |
| Transfer Volume | $14.88B | 2026-08-05 | Dune |
| Total Stake | 434,307,419 | 2026-08-06 | Stakewiz |
| Validator Count | 691 | 2026-08-06 | Stakewiz |
...
| --- | --- | --- | --- |
| Active Addresses | 2026-08-05 | 91.5% | Allium: 605,155, Artemis: 522,413, Blockworks: 316,315, Dune: 597,414, RWA: 605,765 |
...
- **@solana** — Breakpoint 2026: the Token Supercycle. Steel, silicon, energy, and the tokens powering all of it. Speaker applications are now open. Think you belong on that stage? Make your case 👇 https://t.co/Y4xFg8q6Rg [(link)](https://x.com/solana/status/2084709809455342036)
