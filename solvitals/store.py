...
def _flatten(snapshot: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "rev_24h_usd": market.get("fees", {}).get("rev_24h_usd"),
        "network_fees_24h_usd": market.get("fees", {}).get("network_fees_24h_usd"),
        "mev_tips_24h_usd": market.get("fees", {}).get("mev_tips_24h_usd"),
